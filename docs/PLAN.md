...
| [`program/wave-3-build-plan.md`](./program/wave-3-build-plan.md) | Wave 3: public encyclopedia (`site/`, SSG/ISR, trust-badged) + slugs/SEO + D3 graph (W3.1–3.3 ✅); vector backend + human/editorial layer pending | 🟡 in progress |
